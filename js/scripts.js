...
(function ($) {
    ...
    $("#wxgzh").hover(function () {
        $("#wxgzh").css("border:1px red solid");
    }, function () {
        $("#wxgzh").css("border:1px blue solid");
    })*/
    $("#wxgzh , .hexagon").hover(function () {
        $(this).attr({
            "src": "../moban/images/wechatlogo1.png"
        })
    }, function () {
        $(this).attr({
            "src": "../moban/images/wechatlogo.png"
        })
    });
